...
const require = createRequire(import.meta.url); // Usamos 'import.meta.url' para crear 'require' correctamente.
const { name, author } = require(join(__dirname, './package.json')); // Importamos 'package.json'.
const { say } = cfonts;
const rl = createInterface(process.stdin, process.stdout);

// Configuración inicial con CFonts
say('0600\nBot\nMD', {
  font: 'chrome',
  align: 'center',
